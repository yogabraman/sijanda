    ...
    <table border="1" width="100%">
        <tbody>
            ...
            <tr>
                ...
                <td id="left" colspan="3" style="font-size: 13px; padding-left: 10px">: Kabid</td>
            </tr>
            <tr>
                <td id="right" colspan="1" style="font-size: 13px; padding-left: 10px"><strong>Nomor Memo</strong></td>
                <td id="left" colspan="3" style="font-size: 13px; padding-left: 10px">: 20231005/MEMO/1</td>
            </tr>
            <tr>
                <td id="right" colspan="4" style="font-size: 13px; padding-left: 10px">
                    <strong>Isi Memo :</strong><br /> Mohon..... Demikian Terimakasih
                    <div style="height: 50px;"></div>
                </td>
            </tr>
            <tr>
                <td id="right" colspan="2" style="font-size: 13px; padding-left: 10px"></td>
                <td id="left" colspan="2" style="font-size: 13px; text-align:center; padding-left: 10px"><strong>Semarang, 10 Mei 2023 </strong>
